...
public class EAdd  extends Exp {
  ...
  public <R,A> R accept(arithm.Absyn.Exp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof arithm.Absyn.EAdd) {
      arithm.Absyn.EAdd x = (arithm.Absyn.EAdd)o;
