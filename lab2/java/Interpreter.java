...
public class Interpreter {
    ...
    public class DefVisitor implements cmm.Absyn.Def.Visitor<Void, Void> {
        public Void visit(cmm.Absyn.DFun p, Void arg) { /* Code for DFun goes here */
    ...
    public class StmVisitor implements cmm.Absyn.Stm.Visitor<Value, Void> {
        public Value visit(cmm.Absyn.SExp p, Void arg) { /* Code for SExp goes here */
            p.exp_.accept(new ExpVisitor(), arg);
            return null;
        }

        public Value visit(cmm.Absyn.SDecls p, Void arg) { /* Code for SDecls goes here */
            p.type_.accept(new TypeVisitor(), arg);

            for (String id : p.listid_) {
                addVarToContext(id, new VVoid(new ETyped(p.type_, null)));
            }

            return null;
        }

        public Value visit(cmm.Absyn.SInit p, Void arg) { /* Code for SInit goes here */
            Value val = p.exp_.accept(new ExpVisitor(), arg);
            if (val.eTyped.type_.equals(INT) && p.type_.equals(DOUBLE)) {
        ...
        public Value visit(cmm.Absyn.SReturn p, Void arg) { /* Code for SReturn goes here */
            return p.exp_.accept(new ExpVisitor(), arg);
        }

        public Value visit(cmm.Absyn.SWhile p, Void arg) { /* Code for SWhile goes here */
        ...
        public Value visit(cmm.Absyn.SBlock p, Void arg) { /* Code for SBlock goes here */
            newScope();
        ...
        public Value visit(cmm.Absyn.SIfElse p, Void arg) { /* Code for SIfElse goes here */
    ...
    public class ExpVisitor implements cmm.Absyn.Exp.Visitor<Value, Void> {
        public Value visit(cmm.Absyn.ETyped p, Void arg) { /* Code for EBool goes here */
            return p.exp_.accept(new ExpVisitor(), arg);
        }

        public Value visit(cmm.Absyn.EConv p, Void arg) { /* Code for EInt goes here */
            return p.exp_.accept(new ExpVisitor(), arg);
        }

        public Value visit(cmm.Absyn.EBool p, Void arg) { /* Code for EBool goes here */
            Boolean b = p.boollit_.accept(new BoolLitVisitor(), arg);
            return new VBoolean(b, new ETyped(BOOL, p));
        }

        public Value visit(cmm.Absyn.EInt p, Void arg) { /* Code for EInt goes here */
            // p.integer_;
            return new VInteger(p.integer_, new ETyped(INT, p));
        }

        public Value visit(cmm.Absyn.EDouble p, Void arg) { /* Code for EDouble goes here */
            // p.double_;
            return new VDouble(p.double_, new ETyped(DOUBLE, p));
        }
        ...
        public Value visit(cmm.Absyn.EPost p, Void arg) { /* Code for EPost goes here */
            // p.id_;
        ...
        public Value visit(cmm.Absyn.EPre p, Void arg) { /* Code for EPre goes here */
            int n = lookupContextNr(p.id_);
            Value t = lookupVariable(p.id_);
            Boolean b = p.incdecop_.accept(new IncDecOpVisitor(), arg);
            updateVarInContext(p.id_, valueAddition(t, new VInteger(1), b), n);
        ...
        public Value visit(cmm.Absyn.EMul p, Void arg) { /* Code for EMul goes here */
        ...
        public Value visit(cmm.Absyn.EAdd p, Void arg) { /* Code for EAdd goes here */
            Value v1 = p.exp_1.accept(new ExpVisitor(), arg);
        ...
        public Value visit(cmm.Absyn.ECmp p, Void arg) { /* Code for ECmp goes here */
        ...
        public Value visit(cmm.Absyn.EAnd p, Void arg) { /* Code for EAnd goes here */
            Value t1 = p.exp_1.accept(new ExpVisitor(), arg);
            if (!isVBoolean(t1)) {
        ...
        public Value visit(cmm.Absyn.EOr p, Void arg) { /* Code for EOr goes here */
            Value t1 = p.exp_1.accept(new ExpVisitor(), arg);
    ...
    public class BoolLitVisitor implements cmm.Absyn.BoolLit.Visitor<Boolean, Void> {
        public Boolean visit(cmm.Absyn.LTrue p, Void arg) { /* Code for LTrue goes here */
            return true;
        }

        public Boolean visit(cmm.Absyn.LFalse p, Void arg) { /* Code for LFalse goes here */
            return false;
        }
    }
    ...
    public void updateVarInContext(String id, Value t, int contextNr) {
        ...
        Value v = lookupVariable(id);
        if (v.eTyped.type_.equals(DOUBLE) && t.eTyped.type_.equals(INT)) {
            VDouble vd = castToVDouble(t);
            vd.eTyped = new ETyped(DOUBLE, vd.eTyped.exp_);
            cxt.put(id, vd);
        } else {
            cxt.put(id, t);
        }
    ...
    private VDouble castToVDouble(Value v) {
        if (v instanceof VInteger) {
            ...
            return new VDouble(vi.value * 1.0, new ETyped(DOUBLE, v.eTyped.exp_));
        }
        VDouble vd = (VDouble) v;
        return vd;
    }
