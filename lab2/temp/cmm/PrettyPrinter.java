...
public class PrettyPrinter
{
  ...
  private static void ppListDef(java.util.Iterator<cmm.Absyn.Def> it, int _i_)
  {
    if (it.hasNext())
    { /* cons */
      cmm.Absyn.Def el = it.next();
  ...
  private static void ppListArg(java.util.Iterator<cmm.Absyn.Arg> it, int _i_)
  {
    if (it.hasNext())
    {
      cmm.Absyn.Arg el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
  ...
  private static void ppListStm(java.util.Iterator<cmm.Absyn.Stm> it, int _i_)
  {
    if (it.hasNext())
    { /* cons */
      cmm.Absyn.Stm el = it.next();
  ...
  private static void ppListExp(java.util.Iterator<cmm.Absyn.Exp> it, int _i_)
  {
    if (it.hasNext())
    {
      cmm.Absyn.Exp el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
