...
public class PrettyPrinter
{
  ...
  private static void ppListDef(java.util.Iterator<fun.Absyn.Def> it, int _i_)
  {
    if (it.hasNext())
    { /* cons */
      fun.Absyn.Def el = it.next();
      pp(el, _i_); render(";"); ppListDef(it, _i_);
    }
  }
