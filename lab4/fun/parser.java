...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\052\000\006\017\ufffd\023\ufffd\001\002\000\004\002" +
    "\054\001\002\000\006\017\011\023\007\001\002\000\004" +
    "\005\053\001\002\000\006\004\ufffb\023\ufffb\001\002\000" +
    ...
    "\004\050\023\051\001\002\000\014\011\020\013\017\016" +
    "\022\022\016\023\015\001\002\000\006\004\ufffa\023\ufffa" +
    "\001\002\000\004\005\ufffe\001\002\000\006\017\ufffc\023" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\052\000\006\002\003\005\004\001\001\000\002\001" +
    ...
    "\001\000\012\007\022\010\023\011\024\012\051\001\001" +
      ...
      switch (CUP$parser$act_num)
		...
		Object p_3 = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 ...
		 RESULT = new fun.Absyn.ListIdent(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // ListIdent ::= ListIdent _IDENT_ 
            {
              fun.Absyn.ListIdent RESULT =null;
		int p_1left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int p_1right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		fun.Absyn.ListIdent p_1 = (fun.Absyn.ListIdent)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int p_2left = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int p_2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
